...
item1.picture.attach(io: File.open(' items/item1.jpg'), filename: 'item1.jpg')
...
item2.picture.attach(io: File.open(' items/item2.jpg'), filename: 'item2.jpg')
...
item3.picture.attach(io: File.open(' items/item3.jpg'), filename: 'item3.jpg')
...
item4.picture.attach(io: File.open(' items/item4.jpg'), filename: 'item4.jpg')
...
item5.picture.attach(io: File.open(' items/item5.jpg'), filename: 'item5.jpg')
...
item6.picture.attach(io: File.open(' items/item6.jpg'), filename: 'item6.jpg')
...
item7.picture.attach(io: File.open(' items/item7.jpg'), filename: 'item7.jpg')
...
item8.picture.attach(io: File.open(' items/item8.jpg'), filename: 'item8.jpg')
...
item9.picture.attach(io: File.open(' items/item9.jpg'), filename: 'item9.jpg')
...
item10.picture.attach(io: File.open(' items/item10.jpg'), filename: 'item10.jpg')
...
item11.picture.attach(io: File.open(' items/item11.jpg'), filename: 'item11.jpg')
...
item12.picture.attach(io: File.open(' items/item12.jpg'), filename: 'item12.jpg')
...
item13.picture.attach(io: File.open(' items/item13.jpg'), filename: 'item13.jpg')
...
item14.picture.attach(io: File.open(' items/item14.jpg'), filename: 'item14.jpg')
...
item15.picture.attach(io: File.open(' items/item15.jpg'), filename: 'item15.jpg')
...
item16.picture.attach(io: File.open(' items/item16.jpg'), filename: 'item16.jpg')
...
item17.picture.attach(io: File.open(' items/item17.jpg'), filename: 'item17.jpg')
...
item18.picture.attach(io: File.open(' items/item18.jpg'), filename: 'item18.jpg')
...
item19.picture.attach(io: File.open(' items/item19.jpg'), filename: 'item19.jpg')
...
item20.picture.attach(io: File.open(' items/item20.jpg'), filename: 'item20.jpg')
...
item21.picture.attach(io: File.open(' items/item21.jpg'), filename: 'item21.jpg')
...
item22.picture.attach(io: File.open(' items/item22.jpg'), filename: 'item22.jpg')
...
item23.picture.attach(io: File.open(' items/item23.jpg'), filename: 'item23.jpg')
...
item24.picture.attach(io: File.open(' items/item24.jpg'), filename: 'item24.jpg')
...
item25.picture.attach(io: File.open(' items/item25.jpg'), filename: 'item25.jpg')
